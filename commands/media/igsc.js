/**
 * Instagram Sticker Cropped Link Finder - share Instagram post links only
 */
...
module.exports = {
  name: 'igsc',
  aliases: ['igsc', 'instagramstickercrop'],
  category: 'media',
  description: 'Share Instagram post links only instead of downloading media',
  usage: '.igsc <Instagram link or search query>',
  ...
  async execute(sock, msg, args, extra) {
    ...
    if (!query) {
      return await extra.reply('Usage: .igsc <Instagram link or search query>');
    }
